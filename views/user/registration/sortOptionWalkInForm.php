<form style="margin:0px;" onsubmit="walkInRegistrationController.saveSortOption(); return false;">
	<div class="row">
		<div class="span5">
	...
	<div class="row">
		<div class="span5">
			...
			<button class="btn btn-warning" type="button" onclick="walkInRegistrationController.closeSortOptionForm();">Cancel</button>
		</div>
	</div>
</form>
