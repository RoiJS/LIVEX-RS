											...
											<div class="row">
													...
													<div class="row">
															...
															<div class="box well well-small well-shadow mainform">
																<div class="row">
																	<div style="text-align:center;float:left;width:50%;padding-left:40px;">
																		...
																		<p>Total number of pre-registered participants</p>
																	</div>
																	<div>
																		<h3 style="font-size:50px;margin-top:50px;float:right;margin-right: 30px;">
																			<span class="total-registered-students">0</span>
																			<br>
																			<span style="font-size:20px;" class="total-preregistered-percentage">(0%)</span>
																		</h3>
																	</div>
																</div>
															</div>	
														...
														<div class="span5">
															<div class="box well well-small well-shadow mainform">
																<div class="row">
																	<div style="text-align:center;float:left;width:50%;padding-left:40px;">
																		<p>Total number of registrants</p>
																	</div>
																	<div>
																		<h3 style="font-size:30px;float:right;margin-right: 30px;">
																			<?php $totalParticipants = query('SELECT COUNT(*) AS numberOfParticipants FROM tbl_registrants WHERE registration_type = "pre-registered"','','','variable',1);?>
												...
												<div class="span11">
													<div class="well well-small well-shadow mainform"> 
														<legend>Participants Registration <a onclick="registrationController.displaySortOption();"><i style="margin-left:62%;" class="fa fa-gear fa-2x"></i></a></legend>
														<form class="item-select" onsubmit="registrationController.searchPreregisteredParticipant(); return false;">
															<div class="row" style="margin-left:auto;margin-right:auto;">
																<div class="span6" >
																	<select class="select-students span6 txt-preregistered-registant-name" placeholder="Enter student's name&hellip;" >
																		<option></option>
																		<?php $participantList = query('SELECT * FROM tbl_registrants WHERE registration_type = "pre-registered" ORDER BY lastname ASC','','','variable');?>
																	...
																	<div class="span9" style="width:96%;">
																		<div class="table-responsive"  style="overflow-x:auto;height:400px;">
																			<table class="table table-hover table-striped">
																				...
																				<tbody id="displayParticipantsList">	
